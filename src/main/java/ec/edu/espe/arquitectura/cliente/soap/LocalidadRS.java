...
public class LocalidadRS {
    ...
    @XmlElement(required = true)
    protected ec.edu.espe.arquitectura.cliente.soap.Partido partido;
     ...
     *     
     */
    public ec.edu.espe.arquitectura.cliente.soap.Partido getPartido() {
        return partido;
    }
     ...
     *     
     */
    public void setPartido(ec.edu.espe.arquitectura.cliente.soap.Partido value) {
        this.partido = value;
    }
